  ...
  try {
    ...
    if (tab === "day") {
      ...
      result = await db.prepare(`
        ...
        SELECT run_id, d, p, b, s, l, x, ms, i, w, m
        FROM ranked
      ...
      // One best daily run per set of initials for the requested week.
      result = await db.prepare(`
        WITH ranked AS (
          SELECT
            run_id, d, p, b, s, l, x, ms, i, w, m,
  ...
  try {
    ...
    await db.prepare(`
      ...
      ON CONFLICT(run_id) DO UPDATE SET
        ...
        w = excluded.w,
        m = excluded.m
    `).bind(runId, d, p, b, s, l, x, ms, i, w, mode).run();
